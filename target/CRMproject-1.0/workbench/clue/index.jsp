                ...
                $.ajax({
                    ...
                    success: function (data) {
                        $.each(data, function (i, v) {
                            var cmCOchilds = $('#create-owner').children();

                            for (var index = 0; index < cmCOchilds.length; index++) {
                                if (cmCOchilds.eq(index).val() === v.id) {
                                    return false;
                                }
                            }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <select class="form-control" id="create-state">
                                <option></option>
                                <c:forEach items="${clueState}" var="v">
                                    <option value="${v.value}">${v.text}</option>
                                </c:forEach>
                            </select>
                        </div>
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td><a style="text-decoration: none; cursor: pointer;"
                           onclick="window.location.href='workbench/clue/detail.do?id=23abc019eb0f4363a5ef7be8fe28a004'">吴大大</a></td>
                    <td>动力节点</td>
                    <td>010-84846003</td>
                    <td>12345678901</td>
                    <td>广告</td>
                ...
                <tr class="active">
                    <td><input type="checkbox"/></td>
                    <td><a style="text-decoration: none; cursor: pointer;"
                           onclick="window.location.href='workbench/clue/detail.do?id=568d4cfa43bb49aca0a80e862783e580'">张</a></td>
                    <td>动力节点</td>
                    <td>010-84846003</td>
                    <td>12345678901</td>
                    <td>广告</td>
